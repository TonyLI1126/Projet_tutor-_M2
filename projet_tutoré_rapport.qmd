...
La statistique F phylogénétique est :
...
\
nous avons ici une erreur de premiere espece pour le modele classique a 18.2 % qui est bien supérieure a 0.05 et qui montre que ce modele n'est pas adapter pour les données de ce type alors que l'erreur de premiere espece de l'anova phylogénétique bien proche de 0.05 comme attendue
